...
/**
 * Strategy that is used to get {@link Object}s that can be placed in a {@link Collection} where the Generics on that
 * Collection are described as a particular type.
 */
