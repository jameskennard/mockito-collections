...
public interface InjectCollectionsOfSomeMocksIntoAnObjectUnderTestStory {
	 ...
	 */
	void allMocksHaveTheIgnoreInjectableAnnotation();
	 ...
	 * <b>When</b> I setup the JUnit test<br />
	 * <b>Then</b> the mocks without the {@link IgnoreMockForCollections} annotation are injected into the object under test
	 * 
	 * @see ClassWithCollectionOfCollaborators
	 */
	void someMocksHaveTheIgnoreInjectableAnnotation();
